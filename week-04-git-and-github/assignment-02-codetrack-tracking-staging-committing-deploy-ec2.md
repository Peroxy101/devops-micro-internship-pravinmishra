...
![outputpwd](./screenshots/Week4AS2TK1SC1.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![outputgitstatus](./screenshots/Week4AS2TK1SC2.png)
...
![outputls](./screenshots/Week4AS2TK2SC1.png)
...
![editor](./screenshots/Week4AS2TK3SC1.png)
...
![outputgitstatus](./screenshots/Week4AS2TK4SC1.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![outputchanges](./screenshots/Week4AS2TK4SC2.png)
...
![scaffold](./screenshots/Week4AS2TK5SC1.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![outputgitlog](./screenshots/Week4AS2TK5SC2.png)
...
![browserupdated](./screenshots/Week4AS2TK6SC1.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![outputgitstatus](./screenshots/Week4AS2TK6SC2.png)

---

#### Screenshot 11 — Output of `git commit`

![outputgitcommit](./screenshots/Week4AS2TK6SC3.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![outputgitlog](./screenshots/Week4AS2TK6SC4.png)
...
![systemctlnginx](./screenshots/Week4AS2TK7SC1.png)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![outputcurl](./screenshots/Week4AS2TK7SC2.png)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![browsercodetrack](./screenshots/Week4AS2TK7SC3.png)
...
![linkedinpost](./screenshots/linkedin1.png)
---
